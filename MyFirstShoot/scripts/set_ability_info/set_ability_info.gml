...
function set_ability_info(){
	...
	abilityData[2] = new ability_info(2, s_desire, "염원", "일말의 간절한 바램.\n정신력 회복량이 증가합니다."); //염원 desire
	...
	abilityData[5] = new ability_info(5, s_courage, "용기", "그 어떤 상황 속에서도 나아가고자 하는 마음.\n이동속도가 증가합니다."); //용기 courage
