...
function set_ability_info(){
	...
	abilityData[1] = new ability_info(0, s_willingness); //의지 willingness
	abilityData[2] = new ability_info(0, s_desire); //염원 desire
	abilityData[3] = new ability_info(0, s_despair); //절망 despair
