...
function set_ability_info(){
	...
	abilityData[1] = new ability_info(1, s_willingness, "의지", "암담한 현실 속에서도\n절대 꺾이지 않는 마음.\n최대 정신력이 증가합니다."); //의지 willingness
	abilityData[2] = new ability_info(2, s_desire, "염원", "소중한 사람을 향한\n일말의 간절한 바램.\n정신력 회복량이 증가합니다."); //염원 desire
	...
	abilityData[5] = new ability_info(5, s_courage, "용기", "굴하지 않고 앞으로\n나아가는 의연함.\n이동속도가 증가합니다."); //용기 courage
	abilityData[6] = new ability_info(6, s_salvation, "구원", "이 가련한 자를 구원하소서!\n체력을 회복합니다."); //구원 salvation
	abilityData[7] = new ability_info(7, s_hope, "희망", "어둠 속에 한 줄기 희망을!\n사용하면 잠시 무적이 됩니다."); //희망 hope
	abilityData[8] = new ability_info(8, s_scream, "절규", "들어라, 나의 한 맺힌 절규를!\n사용하면 필드 내\n모든 눈물이 소멸하고,\n보스가 잠시 기절합니다."); //절규 scream
	abilityData[9] = new ability_info(9, s_heartbreak, "비통", "이 비통함, 너희도 느껴봐라!\n사용하면 잠시동안\n눈물이 강화됩니다."); //비통 heartbreak
}